	...
	while true do
		...
		if X == 2 and Y == 5 then
			...
			if fs.exists("/luaide") then
				...
				local response = http.get("http://pastebin.com/raw/vyAZc6tJ")
		...
		elseif X == 2 and Y == 7 then
			...
			if fs.exists("/ccBrowser") then
				...
				local response = http.get("http://pastebin.com/raw/XFqcTqLJ")
		...
		elseif X == 2 and Y == 9 then
			...
			local response = http.get("http://pastebin.com/raw/"..textutils.urlEncode(pastebinCode))
